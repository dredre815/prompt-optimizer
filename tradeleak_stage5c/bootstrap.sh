...
set -Eeuo pipefail
umask 077
ISSUE_NUMBER="${TRADELEAK_STAGE5C_ISSUE_NUMBER:-45}"; ATA_COMMIT="${ATA_COMMIT:-6b49ee837ebc1fa0d5bf99d655dc3adc352a77d3}"; NONCE="${GITHUB_RUN_ID}-${GITHUB_RUN_ATTEMPT}-$(date +%s)"
